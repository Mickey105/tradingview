...
function parse(str, format2) {
  var options = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
  try {
    var _options$locale = options.locale, _locale = _options$locale === void 0 ? en_default : _options$locale, _options$backupDate = options.backupDate, backupDate = _options$backupDate === void 0 ? new Date() : _options$backupDate;
...
function PickerInput(originalProps, {
  ...
  const isValidValue = (value) => {
    ...
    return isValidDate2(value) && !props.disabledDate(value);
  };
  const text = computed(() => {
...
// dep:vue-datepicker-next
var vue_datepicker_next_default = index;
export {
  vue_datepicker_next_default as default
};
