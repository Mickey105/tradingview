const common = {
  ru: {
    ...
    built_by: "Создано на базе платформы компании Polygant",
  ...
  en: {
    ...
    wrong_data: "Invalid data - Wrong Email or Password",
    ...
    coinsafter1:
      "Coins will be show at deposit immediately after 1 network confirmation",
    ...
    built_by: "Built using  platform by Polygant",
